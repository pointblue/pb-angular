...
function SliderDirective($$rAF, $window, $mdAria, $mdUtil, $mdConstant, $mdTheming, $mdGesture, $parse, $log, $timeout) {
  ...
  function postLink(scope, element, attr, ctrls) {
    ...
    angular.isDefined(attr.steps)? updateSteps( scope.steps ) : updateSteps(null);
    ...
    function redrawTicks() {
      ...
      for (var i = 0; i <= numSteps; i++) {
          ...
          multiplier = steps ? valueToPercent(steps[i]) : (i / numSteps);
